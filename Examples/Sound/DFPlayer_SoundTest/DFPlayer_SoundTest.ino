...
/**
The purpose of this sketch is to test the DFPlayer implimentation of the Universal 
...
#define RX_PIN 11 //Receive serial pin for DFPlayer
#define TX_PIN 12 //Transmit serial pin for DFPlayer

static DFPlayerSoundMap gSoundMap;
...
void loop()
{
  Serial.println("Testing DFPlayer Sound player");
  ...
  ASoundPlayer* lpSoundPlayer = new DFPlayerSoundPlayer(RX_PIN, TX_PIN, &gSoundMap);
